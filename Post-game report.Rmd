...
# library(DT)
# library(devtools)
# library(baseballr) - might need this one to get the data
# library(DBI)
# library(RSQLite)
...
#season <- baseballr::statcast_search(start_date = '2022-09-24', end_date = '2022-09-24')
#season <- baseballr::statcast_search(start_date = '2022-09-30', end_date = '2022-09-30')
#season <- baseballr::statcast_search(start_date = '2022-10-08', end_date = '2022-10-08')
...
ggplot(NL_CY, aes(as.factor(pitch_name), release_spin_rate, fill=pitch_name)) +
  ...
  xlab("Pitch Name") +
  ylab("Spin Rate") +
  #ggtitle("Jacob deGrom Spin Rate Bands") +
...
ggplot(NL_CY, aes(as.factor(pitch_name), release_speed, fill=pitch_name)) +
  ...
  #ggtitle("Jacob deGrom Pitch Speed Bands") +
  theme(legend.position="bottom")
```
